import { Box, type ScrollBoxHandle, stringWidth, Text } from '@lemon-ai/ink'
...
export function StatusRule({
  ...
  // Dev-only readout (LEMON_DEV_CREDITS). The server omits the key entirely unless the
  ...
  // Dev-gated readout (LEMON_DEV_CREDITS), lowest priority,
