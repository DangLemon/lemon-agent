 ...
 *
 * Symptom: in `lemon --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@lemon-ai/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using lemon --tui and as i type multiline my caret at the end will often ' +
