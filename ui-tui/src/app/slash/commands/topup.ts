import { driveChargeSettlement, type SettlementOutcome } from '@lemon-ai/shared/charge-settlement'
...
const renderBillingError = (
  ...
  switch (env.error) {
    ...
    case 'remote_spending_disabled':
      ...
      // turn it on from the portal's Lemon AI page; this is NOT a per-terminal stop.
      sys(
