...
import type { ScrollBoxHandle } from '@lemon-ai/ink'
import { evictInkCaches } from '@lemon-ai/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.LEMON_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
