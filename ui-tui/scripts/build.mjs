...
await build({
  ...
  // Skip the prebuilt @lemon-ai/ink bundle and inline the source instead:
  ...
  alias: { '@lemon-ai/ink': resolve(root, 'packages/lemon-ink/src/entry-exports.ts') },
...
// the `node` token, leaving a broken interpreter). The lemon_cli launcher
