 ...
 * across theme x background scenes to <tmpdir>/lemon-tui-visual/tui-visual.html,
...
import { Box, renderSync, Text } from '@lemon-ai/ink'
...
// The regenerated slate light_colors block from lemon_cli/skin_engine.py
// (relight recipe: vivid hue-preserved accents, airy capped-saturation text,
// darker calm dims).

const info: SessionInfo = {
  cwd: '/Users/brooklyn/www/lemon-agent',
...
const setup = (bgHex: string) => {
  process.env.LEMON_TUI_BACKGROUND = bgHex
  resetOverlayState()
  resetUiState()
}
