...
Registry of record: `lemon_cli/commands.py` (`COMMAND_REGISTRY`) — every
...
/snapshot [sub]          Create/restore Lemon AI config+state snapshots (CLI)
...
/update                  Update Lemon AI to latest
