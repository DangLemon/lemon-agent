/**
 * Lemon AI desktop plugin template. Save as:
 *   <lemon home>/desktop-plugins/<id>/plugin.js   (folder name == id)
 * where <lemon home> is ~/.lemon-ai by default, or ~/.lemon-ai/profiles/<name>
 * when running a named profile (`lemon -p <name>`). Run `lemon doctor` (or
 ...
 * Only these imports resolve: @lemon-ai/plugin-sdk, react, react/jsx-runtime.
 */

import { cn, haptic, host, Tip, usePluginI18n, useValue } from '@lemon-ai/plugin-sdk'
