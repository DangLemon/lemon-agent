#!/usr/bin/env python3
"""Google Workspace API CLI for Lemon AI.

Uses the Google Workspace CLI (`gws`) when available, but preserves the
existing Lemon AI-facing JSON contract and falls back to the Python client
...
from _lemon_home import get_lemon_home
...
def _gws_binary() -> str | None:
    override = os.getenv("LEMON_GWS_BIN")
    if override:
        return override
...
def main():
    parser = argparse.ArgumentParser(description="Google Workspace API for Lemon AI")
