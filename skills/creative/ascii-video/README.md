...
Built for [Lemon AI](https://github.com/DangLemon/lemon-agent). Usable in any coding agent. Canonical source lives here; synced to [`DangLemon/lemon-agent/skills/creative/ascii-video`](https://github.com/DangLemon/lemon-agent/tree/main/skills/creative/ascii-video) via PR.
