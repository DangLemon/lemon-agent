...
_ECHO_TAG = "lemon-agent"  # tag added to outgoing messages for echo-loop prevention
...
def register(ctx) -> None:
    """Plugin entry point — called by the Lemon AI plugin system at startup."""
    ctx.register_platform(
        ...
        required_env=["NTFY_TOPIC"], install_hint="pip install httpx   # already a Lemon AI dependency",
