...
# `require_mention: true` without custom aliases uses Lemon AI wake words.
DEFAULT_MENTION_PATTERNS = [r"(?<![\w@])@?lemon\s+agent\b[,:\-]?", r"(?<![\w@])@?lemon\b[,:\-]?"]
...
class BlueBubblesAdapter(BasePlatformAdapter):
    ...
    def _compile_mention_patterns(raw: Any) -> List[re.Pattern]:
        ...
        comma/newline-separated), or None (Lemon AI defaults)."""
