...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        _cmd("reset", "Reset your Lemon AI session"),
        ...
        _cmd("status", "Show Lemon AI session status"),
        _cmd("sethome", "Set this chat as the home channel"),
        _cmd("stop", "Stop the running Lemon AI agent"),
        ...
        _cmd("update", "Update Lemon AI to the latest version"),
        _cmd("restart", "Gracefully restart the Lemon AI gateway"),
        ...
        _cmd("thread", "Create a new thread and start a Lemon AI session in it",
