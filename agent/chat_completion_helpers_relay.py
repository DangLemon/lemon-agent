...
as the provider stream ends — concurrently with Lemon AI' consumer thread, which may not have
...
class RelayChatAccumulator:
    ...
    def observe(self, chunk: Any) -> None:
        ...
        choice = choices[0] if choices else None  # Lemon AI never requests n>1
