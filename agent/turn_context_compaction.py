...
def _codex_native_auto_compaction(agent: Any) -> bool:
    """Codex app-server threads are compacted by the codex agent itself; Lemon AI only
    initiates compaction in "lemon" mode."""
    return (
        # See #36801.
...
def _preflight_compression(
    ...
    if _preflight_deferred:
        ...
        logger.info(
            "Skipping Lemon AI preflight compression for codex app-server "
            "(mode=%s); Lemon AI will not start thread compaction here.",
