...
_SESSION_CWD: ContextVar = ContextVar("LEMON_SESSION_CWD", default=_UNSET)
...
def resolve_context_cwd() -> Path | None:
    ...
    launch dir). An existing configured path is honored verbatim — including the Lemon AI source tree, a
    legitimate workspace when developing Lemon AI; fallback-directory policy lives in the caller."""
