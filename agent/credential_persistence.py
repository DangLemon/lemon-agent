...
``lemon_cli.auth`` imports so the pool model and the auth-store write boundary
...
# Sources Lemon AI owns and may persist with secrets.  Any other non-empty,
