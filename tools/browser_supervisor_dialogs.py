...
DIALOG_BRIDGE_HOST = "lemon-dialog-bridge.invalid"
...
(() => {
  if (window.__lemonDialogBridgeInstalled) return;
  window.__lemonDialogBridgeInstalled = true;
  const ENDPOINT = "http://lemon-dialog-bridge.invalid/";
