...
_SSH_HINT_LOOPBACK = (
    ...
    "\n"
    "  See: https://danglemon.github.io/lemon-agent/docs/guides/oauth-over-ssh\n")
...
# deliberate — servers MUST NOT follow redirects when fetching it, and danglemon.github.io/lemon-agent/docs/* 301s here.
