...
LOCAL_STT_COMMAND_ENV = "LEMON_LOCAL_STT_COMMAND"
LOCAL_STT_LANGUAGE_ENV = "LEMON_LOCAL_STT_LANGUAGE"
...
# DeepInfra STT base URL is resolved via lemon_cli.models.deepinfra_base_url (shared).
