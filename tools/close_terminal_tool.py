"""Close a read-only agent terminal tab in the Lemon AI desktop GUI WITHOUT killing
...
CLOSE_TERMINAL_SCHEMA = {
    ...
    "description": (
        ...
        "the Lemon AI desktop GUI (the tabs mirroring terminal(background=true) runs). "
