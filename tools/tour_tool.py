"""Guided tour (highlight + narrate UI elements) in the Lemon AI desktop GUI: the agent discovers
...
def tour_tool(action: str = "", surface: Optional[str] = None, selector: Optional[str] = None,
    ...
    if callback is None:
        return tool_error("tour is only available in the Lemon AI desktop app.")
...
TOUR_SCHEMA = {
    ...
    "description": (
        ...
        "element, attach a titled popover. Surfaces: 'app' (Lemon AI itself) "
