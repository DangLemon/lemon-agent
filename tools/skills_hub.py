...
Used by lemon_cli/skills_hub.py for CLI commands and the /skills slash command.
"""
...
_skills_dir = _path_resolver("SKILLS_DIR", "LEMON_HOME", "skills")
...
_DYNAMIC_PATH_RESOLVERS = {"LEMON_HOME": _lemon_home, **{
...
_PLUGIN_COMPAT_LAZY = {
    ...
    'LEMON_INDEX_TTL': ('tools.skills_hub_search', 'LEMON_INDEX_TTL'),
    'LEMON_INDEX_URL': ('tools.skills_hub_search', 'LEMON_INDEX_URL'),
    'LemonIndexSource': ('tools.skills_hub_official', 'LemonIndexSource'),
