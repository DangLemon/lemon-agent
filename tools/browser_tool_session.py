...
_DOCKER_PULL = "docker pull ghcr.io/danglemon/lemon-agent:latest"
...
def _prepare_session_socket_dir(session_name: str) -> str:
    ...
    with our PID BEFORE first use — another lemon process's orphan reaper rmtree's any
...
def _create_local_session(task_id: str, allow_real_profile: bool = True) -> Dict[str, str]:
    ...
    # Browser Use mode + ``browser.engine: lightpanda`` drives a Lemon AI-spawned
