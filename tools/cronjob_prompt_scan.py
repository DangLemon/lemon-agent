...
# containing `cat ~/.lemon-ai/.env` or `rm -rf /`; there it is a smoking gun, not prose.
...
# `lemon-agent-dev` skill contains a security postmortem mentioning `cat ~/.lemon-ai/.env`, which tripped
