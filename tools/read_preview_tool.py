#!/usr/bin/env python3
"""Read the in-app browser / preview pane in the Lemon AI desktop GUI.
...
def read_preview_tool(
    ...
    return read_pane(callback, (("start", start, 0), ("count", count, 1)), (
        "read_preview is only available in the Lemon AI desktop app.",
...
READ_PREVIEW_SCHEMA = {
    ...
    "description": (
        ...
        "Lemon AI desktop GUI (the pane open_preview opens beside this chat). Call "
