"""Relay subscriber for the persisted Lemon AI shared-metrics slice."""
...
class SharedMetricsSubscriber:
    """Persist validated Lemon AI counters from Relay lifecycle events."""
    ...
    def __call__(self, event: Any) -> None:
        ...
        with self._lock:
            ...
            try:
                ...
                logger.warning(
                    "Unable to persist the Lemon AI shared metric: %s", metric_name, exc_info=True
                )
