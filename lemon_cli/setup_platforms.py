...
def _setup_webhooks():
    ...
    print()
    _info("   Full guide: https://danglemon.github.io/lemon-agent/docs/user-guide/messaging/webhooks/", None)
    ...
    _info(f"   1. Define webhook routes in {_dhh()}/config.yaml",
          ...
          "   https://danglemon.github.io/lemon-agent/docs/user-guide/messaging/webhooks/#configuring-routes",
          None,
