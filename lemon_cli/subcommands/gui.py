...
def build_gui_parser(subparsers, *, cmd_gui: Callable) -> None:
    ...
    gui_parser = subparsers.add_parser(
        ...
        description="Launch the Lemon AI Electron desktop app. By default this installs "
    ...
    gui_parser.add_argument(
        ...
        help="Force Desktop to ignore any lemon CLI already on PATH during backend resolution")
    gui_parser.add_argument(
        "--lemon-root",
        help="Override the Lemon AI source root used by Desktop (sets LEMON_DESKTOP_LEMON_ROOT)")
    gui_parser.add_argument(
        "--cwd",
        help="Initial project directory for Desktop chat sessions (sets LEMON_DESKTOP_CWD)")
    gui_parser.add_argument(
    ...
    gui_parser.add_argument(
        "--identity", default="Lemon AI Local Signing",
        help="Certificate name to create/use for --setup-tcc-identity (default: Lemon AI Local Signing)",
    )
