"""``lemon profile`` subcommand parser."""
...
def build_profile_parser(subparsers, *, cmd_profile: Callable) -> None:
    ...
    profile_parser = subparsers.add_parser(
        "profile", help="Manage profiles — multiple isolated Lemon AI instances")
    ...
    profile_create.add_argument(
        ...
        help="Create an empty profile with no bundled skills (opts out of `lemon update` skill sync)",
    )
    profile_create.add_argument(
        ...
        help="One- or two-sentence description of what this profile is good at. "
             ...
             "of profile name alone. Skip and add later via `lemon profile describe`.")
    ...
    profile_export.add_argument(
        ...
        help="Output file (default: a managed profile-exports/<name>-<timestamp>.tar.gz "
             "under the default Lemon AI home)")
    ...
    profile_install = profile_subparsers.add_parser(
        ...
        description="Install a Lemon AI profile distribution. SOURCE can be a git URL "
