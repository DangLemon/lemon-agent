...
def build_setup_parser(subparsers, *, cmd_setup: Callable) -> None:
    ...
    setup_parser = subparsers.add_parser(
        ...
        description="Configure Lemon AI with an interactive wizard. "
        "Run a specific section: "
        "lemon setup model|tts|terminal|gateway|tools|telemetry|agent")
    ...
    setup_parser.add_argument(
        ...
        "compatibility — a bare 'lemon setup' now does this.")
    setup_parser.add_argument(
