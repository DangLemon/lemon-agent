...
def maybe_grow_window(model_id: str, *, base_url: str, session_tokens: int,
    ...
    """
    from lemon_cli.local_runtime.bootstrap import (
        get_supervisor, refresh_local_runtime, staged_models)
    from lemon_cli.local_runtime.context_policy import growth_decision
    from lemon_cli.local_runtime.estimator import profile_from_gguf
    from lemon_cli.local_runtime.gguf import read_gguf_header
