"""Shared migration guards for Lemon AI' native NeMo Relay ownership."""
...
RELAY_PLUGINS_CONFIG_ENV = "LEMON_NEMO_RELAY_PLUGINS_TOML"

LEGACY_RELAY_PLUGIN_KEYS = frozenset({"nemo_relay", "observability/nemo_relay"})

LEGACY_RELAY_EXPORT_ENV_VARS = frozenset({
    "LEMON_NEMO_RELAY_ATOF_ENABLED",
    "LEMON_NEMO_RELAY_ATOF_OUTPUT_DIRECTORY",
    "LEMON_NEMO_RELAY_ATOF_FILENAME",
    "LEMON_NEMO_RELAY_ATOF_MODE",
    "LEMON_NEMO_RELAY_ATIF_ENABLED",
    "LEMON_NEMO_RELAY_ATIF_OUTPUT_DIRECTORY",
    "LEMON_NEMO_RELAY_ATIF_FILENAME_TEMPLATE",
    "LEMON_NEMO_RELAY_ATIF_AGENT_NAME",
    "LEMON_NEMO_RELAY_ATIF_AGENT_VERSION",
    "LEMON_NEMO_RELAY_ATIF_EXPORT_TIMEOUT_S",
    "LEMON_NEMO_RELAY_ATIF_MODEL_NAME",
    "LEMON_NEMO_RELAY_ATIF_SUBAGENT_EXPORT_MODE",
})
