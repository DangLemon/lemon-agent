...
def run_whatsapp_cloud_setup() -> int:
    ...
    _lines(
        ...
        "This wizard configures Lemon AI to talk to WhatsApp via Meta's",
    ...
    _lines(
        "", "  Lemon AI needs a public HTTPS URL to receive WhatsApp messages.",
        ...
        "    3. Start the Lemon AI gateway in another terminal:",
        "         lemon gateway", "",
    ...
    _lines(
        ...
        "  Docs: https://github.com/DangLemon/lemon-agent/docs/user-guide/",
