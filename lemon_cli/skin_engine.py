"""Lemon AI skin/theme engine — the theme SDK for every surface."""
...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces LEMON_AGENT_LOGO)
    banner_hero: str = ""    # Rich-markup hero art (replaces LEMON_CADUCEUS)
...
# Branding shared by every Lemon AI-named built-in (mono/daylight override help_header).
_LEMON_BRANDING: Dict[str, str] = _branding(
    "Lemon AI", "⚕", "Goodbye! ⚕", prompt="❯", help_header="(^_^)? Available Commands")

_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default", "description": "Classic Lemon AI — gold and kawaii",
...
[dim #6B1717]⠀⠀⠀⠀⠀⠀⠀⠀war god online⠀⠀⠀⠀⠀⠀⠀⠀[/]""",
    ...
    "mono": {
        ...
        "spinner": {},
        "branding": {**_LEMON_BRANDING, "help_header": "[?] Available Commands"},
        "tool_prefix": "┊"},
    "slate": {
        ...
        "spinner": {}, "branding": _LEMON_BRANDING, "tool_prefix": "┊"},
    "daylight": {
        "name": "daylight",
