...
The unit tests in tests/lemon_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned lemon-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/lemon")
from lemon_cli.service_manager import S6ServiceManager
