...
def ledger_env(tmp_path, monkeypatch):
    """Isolated LEMON_HOME + skills dir for skill_manage and the ledger."""
    ...
    monkeypatch.setattr(skill_ledger, "get_lemon_home", lambda: home)
    monkeypatch.setattr(skill_usage, "get_lemon_home", lambda: home)
...
def test_rollback_refuses_paths_outside_lemon_home(ledger_env):
    """A hand-edited ledger entry pointing outside LEMON_HOME must not
