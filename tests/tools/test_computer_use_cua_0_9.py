...
def _make_backend(session: _FakeSession):
    ...
    backend._session_id = "lemon-session"
...
def test_backends_are_isolated_by_lemon_session_and_reused_within_it():
...
def test_concurrent_lemon_sessions_do_not_share_backend_state():
    from tools.computer_use import tool as computer_use
