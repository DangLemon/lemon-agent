...
Damien's incident (Discord, 2026-05-28): a long Lemon AI session in a Discord
...
def _make_legacy_session_db_class() -> type:
    ...
    imports the same still-loaded ``lemon_state`` module, whose ``SessionDB``
    ...
    namespace = {"__name__": "lemon_state"}
    source = '''
class SessionDB:
...
_NominalSessionDBImpostor.__module__ = "lemon_state"
