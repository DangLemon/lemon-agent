...
manipulation. Lemon AI keeps canonical conversation history in state.db and may
...
def fake_homes(tmp_path, monkeypatch):
    """Point LEMON_HOME at a temp profile dir.

    Uses the real env-var resolution chain (get_lemon_home /
    get_default_lemon_root) instead of monkeypatching private helpers —
    ...
    LEMON_HOME=<root>/profiles/<name> makes get_default_lemon_root()
