...
thinking phase.  Lemon AI's default cloud-stream stale detector
(``LEMON_STREAM_STALE_TIMEOUT`` = 180s) and non-stream detector
(``LEMON_API_CALL_STALE_TIMEOUT`` = 90s) both fire before the
