"""Session <-> workspace grouping key (lemon_state_sessions.workspace_key).

The key is what `lemon sessions list --workspace` groups/filters on. It is a
...
import lemon_state_sessions
from lemon_state_sessions import workspace_key
