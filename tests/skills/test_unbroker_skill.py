...
# Resolve the skill's scripts dir across layouts: standalone dev repo (tests/) and lemon-agent
...
_CANDIDATES = [
    ...
    _HERE.parent.parent.parent.joinpath(*_REL),          # lemon-agent (tests/skills/)
]
