"""The `lemon-agent` skill is what a running Lemon AI knows about itself.

`website/` is never packaged, so an installed Lemon AI has no local copy of the
user guide; skills ARE synced into `$LEMON_HOME/skills/`. The skill therefore
...
shipped feature is invisible and the agent answers "Lemon AI can't do that."
"""
...
SKILL_DIR = REPO / "skills" / "autonomous-ai-agents" / "lemon-agent"
