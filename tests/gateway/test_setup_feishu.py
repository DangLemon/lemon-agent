"""Tests for _setup_feishu() in lemon_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("lemon_cli.config.save_env_value", side_effect=mock_save), \
         patch("lemon_cli.config.get_env_value", side_effect=mock_get), \
         patch("lemon_cli.config.remove_env_value", side_effect=mock_remove), \
         patch("lemon_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("lemon_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("lemon_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("lemon_cli.cli_output.print_header"), \
         patch("lemon_cli.cli_output.print_info"), \
         patch("lemon_cli.cli_output.print_success"), \
         patch("lemon_cli.cli_output.print_warning"), \
         patch("lemon_cli.cli_output.print_error"), \
