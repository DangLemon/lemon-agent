...
def gateway_home(monkeypatch, tmp_path):
    ...
    monkeypatch.delenv("LEMON_PREFILL_MESSAGES_FILE", raising=False)
    monkeypatch.delenv("LEMON_EPHEMERAL_SYSTEM_PROMPT", raising=False)
    ...
    monkeypatch.delenv("LEMON_BACKGROUND_NOTIFICATIONS", raising=False)
    return tmp_path
