...
def test_load_transcript_returns_db_messages_when_no_jsonl(tmp_path, monkeypatch):
    ...
    ~/.lemon-ai/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at lemon_state import time, before pytest's LEMON_HOME monkeypatch
    fires — the autouse fixture's LEMON_HOME override doesn't help here.)
    """
    import lemon_state
