...
class TestGetCopilotModelContext:
    ...
    @patch("lemon_cli.models.fetch_github_model_catalog", return_value=_SAMPLE_CATALOG)
    ...
    @patch("lemon_cli.models._urlopen_model_catalog_request")
    ...
    @patch("lemon_cli.models.fetch_github_model_catalog", return_value=[])
