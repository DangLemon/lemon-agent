...
``LEMON_PORTAL_BASE_URL=https://portal.staging-nousresearch.com`` in its
...
class TestPortalEnvOverrideHelper:
    def test_none_when_unset(self, monkeypatch):
        monkeypatch.delenv("LEMON_PORTAL_BASE_URL", raising=False)
    ...
    def test_env_override_not_gated_by_allowlist(self, monkeypatch):
        ...
        monkeypatch.setenv(
            "LEMON_PORTAL_BASE_URL", "https://portal.staging-nousresearch.com"
        )
...
class TestResolveAccessTokenEnvOverrideWins:
    ...
    def test_env_override_wins_even_with_staging_state_stored(
        ...
        a prior LEMON_AUTH_JSON_BOOTSTRAP seed), and the env var is set to
        ...
        monkeypatch.setenv("LEMON_PORTAL_BASE_URL", staging_portal)
