"""Tests for the shared tar.gz writer (``lemon_cli.archive_safe.make_targz``).

``make_targz`` backs both ``lemon profile export`` and ``lemon kanban
...
from lemon_cli.archive_safe import make_targz
