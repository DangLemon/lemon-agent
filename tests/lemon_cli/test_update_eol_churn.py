"""Regression: ``lemon update`` should take a managed checkout off autocrlf=true.
...
``lemon update`` has to repair them.
...
from lemon_cli.update_cmd import _normalize_managed_eol
