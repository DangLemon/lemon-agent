...
the *mutation* side: `lemon plugins enable/disable` must resolve a bare name
...
class TestResolvePluginKey:
    @patch("lemon_cli.plugins.get_bundled_plugins_dir")
    ...
    def test_full_key_resolves_to_itself(self, mock_user, mock_bundled, nested_plugin_env):
        from lemon_cli.plugins_cmd import _resolve_plugin_key
...
class TestEnableDisableNested:
    @patch("lemon_cli.plugins.get_bundled_plugins_dir")
    @patch("lemon_cli.plugins_cmd._plugins_dir")
    @patch("lemon_cli.plugins_cmd._save_disabled_set")
    @patch("lemon_cli.plugins_cmd._save_enabled_set")
    @patch("lemon_cli.plugins_cmd._get_disabled_set", return_value=set())
    @patch("lemon_cli.plugins_cmd._get_enabled_set", return_value=set())
...
class TestEnableToolOverrideConsent:
    ...
    @patch("lemon_cli.plugins.get_bundled_plugins_dir")
    @patch("lemon_cli.plugins_cmd._plugins_dir")
    @patch("lemon_cli.plugins_cmd._set_plugin_entry_flag")
    @patch("lemon_cli.plugins_cmd._save_disabled_set")
    @patch("lemon_cli.plugins_cmd._save_enabled_set")
    @patch("lemon_cli.plugins_cmd._get_disabled_set", return_value=set())
    @patch("lemon_cli.plugins_cmd._get_enabled_set", return_value=set())
...
class TestCompositeMenuWritesCanonicalKey:
    """#40190 follow-up: the interactive `lemon plugins` menu must persist
    ...
    def test_fallback_unchecked_plugin_disables_by_key_not_name(
        ...
        from lemon_cli.plugins_cmd import _run_composite_fallback
