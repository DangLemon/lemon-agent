"""Fetch-failure classification for `lemon update` / `lemon update --check`.
...
CURL_429_STDERR = (
    "fatal: unable to access 'https://github.com/DangLemon/lemon-agent.git/':"
...
def test_update_network_git_calls_never_prompt_for_credentials():
    ...
    Live incident (Sep 2026): a GitHub-side 401 made `lemon update` sit on
    ...
    from lemon_cli import update_cmd_git
