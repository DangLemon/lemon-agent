"""Tests for `_can_open_graphical_browser()` in lemon_cli.auth.

Guards the fix for the May 2026 report where `lemon auth add xai-oauth`
...
from lemon_cli.auth import _can_open_graphical_browser
