"""Tests for the interactive session browser (`lemon sessions browse`).
...
from lemon_cli.sessions_cmd_browse import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """lemon sessions browse should be parseable."""
