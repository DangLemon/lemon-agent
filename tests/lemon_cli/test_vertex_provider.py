...
def test_vertex_registered_in_provider_registry():
    """PROVIDER_REGISTRY (lemon_cli.auth) is what agent/auxiliary_client.py's
...
def test_vertex_registered_in_lemon_overlays():
    """lemon_cli.providers.get_provider("vertex") backs
