...
from lemon_cli.commands import GATEWAY_KNOWN_COMMANDS, SUBCOMMANDS, gateway_help_lines, resolve_command
from lemon_cli.commands_completion import SlashCommandCompleter
from lemon_cli.commands_platforms import telegram_bot_commands
...
def _isolate_config(monkeypatch, home):
    ...
    monkeypatch.setenv("LEMON_MANAGED_DIR", str(home / "missing-managed"))
    from lemon_cli import managed_scope
    from lemon_cli.config import _LOAD_CONFIG_CACHE, _RAW_CONFIG_CACHE
