"""Tests for Blank Slate setup mode (lemon_cli/setup.py).
...
from lemon_cli.setup_quick import _blank_slate_minimal_toolsets, _blank_slate_minimize_config
