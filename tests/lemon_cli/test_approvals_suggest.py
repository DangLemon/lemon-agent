"""Tests for ``lemon approvals suggest`` (lemon_cli/approvals_suggest.py).

Approval history in Lemon AI is implied, not ledgered: the session DB
...
from lemon_cli.approvals_suggest import (
    Proposal,
    apply_proposals,
    build_proposals,
    derive_glob,
