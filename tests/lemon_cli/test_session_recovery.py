...
from lemon_cli import session_recovery
...
def test_snapshot_blocks_connections_opened_during_the_copy(
    ...
    from lemon_cli import session_recovery as recovery_module
...
def test_cli_allow_partial_salvages_rows_across_a_corrupt_leaf(
    ...
    env = os.environ.copy()
    env["LEMON_HOME"] = str(tmp_path / "isolated-lemon-home")
...
def test_lost_and_found_direct_copy_creates_lazy_delivery_ledger(tmp_path: Path) -> None:
    ...
    from lemon_cli.session_lost_and_found import _copy_direct_tables
