...
import lemon_cli.model_switch_providers as lemon_cli_model_switch_providers
...
def test_passthrough_kwargs_to_base(monkeypatch):
    ...
    monkeypatch.setattr(lemon_cli_model_switch_providers, "list_authenticated_providers", _capture)
    monkeypatch.setattr("lemon_cli.models.fetch_openrouter_models",
                        lambda *a, **kw: [])
...
def _stub_kimi_discovery(monkeypatch, *, canonical):
    ...
    import lemon_cli.models as hm
    import lemon_cli.models_catalog_static as lemon_cli_models_catalog_static
    from lemon_cli import models_catalog_static
    ...
    monkeypatch.setattr(lemon_cli_models_catalog_static, "CANONICAL_PROVIDERS", canonical)
