"""Tests for the shared byte formatter (lemon_cli.sizefmt).
...
def test_migrated_sites_render_through_the_shared_helper():
    ...
    from lemon_cli.backup import _format_size as backup
    from lemon_cli.checkpoints import _fmt_bytes as checkpoints
    from lemon_cli.sizefmt import format_bytes as doctor
