...
where lemon's shared picker expects ``prompt`` / ``completion``; these tests
pin the translation and the curated-list filtering.
"""
import json
from unittest.mock import patch, MagicMock

from lemon_cli import models as models_module
from lemon_cli import models_pricing
from lemon_cli.models import VERCEL_AI_GATEWAY_MODELS, _ai_gateway_model_is_free, fetch_ai_gateway_models
from lemon_cli.models_pricing import fetch_ai_gateway_pricing
