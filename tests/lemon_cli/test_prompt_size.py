"""Tests for the ``lemon prompt-size`` diagnostic (issue #34667)."""
...
from lemon_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(lemon_home, memory_text="", user_text=""):
    mem_dir = lemon_home / "memories"
...
def _seed_skill(lemon_home, name, description):
    skill_dir = lemon_home / "skills" / "demo" / name
