...
Run before any catalog commit:
    ...
    LEMON_TEST_NETWORK=1 scripts/run_tests.sh tests/lemon_cli/test_catalog_reachability.py
"""
...
pytestmark = pytest.mark.skipif(
    not os.environ.get("LEMON_TEST_NETWORK"),
    reason="network test; set LEMON_TEST_NETWORK=1 to run",
)
