"""Tests for `lemon chat --safe-mode` isolation."""
...
_VARS = ("LEMON_SAFE_MODE", "LEMON_IGNORE_USER_CONFIG", "LEMON_IGNORE_RULES")
...
def test_cmd_chat_safe_mode_sets_env_before_startup(monkeypatch):
    ...
    def fake_has_provider() -> bool:
        assert os.environ["LEMON_SAFE_MODE"] == "1"
        assert os.environ["LEMON_IGNORE_USER_CONFIG"] == "1"
        assert os.environ["LEMON_IGNORE_RULES"] == "1"
        return True
