"""Tests for the specifier module + `lemon kanban specify` CLI surface.
...
from lemon_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `lemon kanban …` argparse surface directly."""
