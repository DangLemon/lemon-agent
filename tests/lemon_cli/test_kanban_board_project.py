...
A kanban board can be scoped to a first-class Lemon AI project so every task on
...
def fresh_home(tmp_path, monkeypatch):
    ...
    for var in ("LEMON_KANBAN_DB", "LEMON_KANBAN_WORKSPACES_ROOT", "LEMON_KANBAN_HOME", "LEMON_KANBAN_BOARD"):
