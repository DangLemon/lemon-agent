...
from lemon_cli.model_setup_flows_common import _existing_api_key_for_model_flow
...
def test_generic_api_key_flow_passes_pool_key_to_existing_key_prompt(monkeypatch):
    ...
    with (
        ...
        patch("lemon_cli.main_provider_setup._prompt_api_key", side_effect=capture_prompt),
    ):
...
def test_bedrock_flow_sees_pool_key_when_no_env(monkeypatch, capsys):
    ...
    from lemon_cli.model_setup_flows_bedrock import _model_flow_bedrock_api_key
