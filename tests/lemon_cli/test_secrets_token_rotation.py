"""Tests for `lemon secrets bitwarden token` / `lemon secrets onepassword token`.
...
from lemon_cli import onepassword_secrets_cli as op_cli
from lemon_cli import secrets_cli as bw_cli
