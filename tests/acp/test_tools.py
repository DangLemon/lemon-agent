...
COMMON_LEMON_TOOLS = ["read_file", "search_files", "terminal", "patch", "write_file", "process"]


class TestToolKindMap:
    def test_all_lemon_tools_have_kind(self):
        """Every common lemon tool should appear in TOOL_KIND_MAP."""
        for tool in COMMON_LEMON_TOOLS:
...
class TestBuildToolTitle:
    ...
    def test_execute_code_title_includes_first_code_line(self):
        ...
        assert title == "python: from lemon_tools import terminal"
