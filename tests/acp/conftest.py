...
Keeps the ACP server tests offline: ``LemonACPAgent._build_model_state``
calls ``lemon_cli.inventory.build_models_payload``, which (without this
...
def _offline_model_inventory(monkeypatch):
    ...
    import lemon_cli.inventory as inventory
