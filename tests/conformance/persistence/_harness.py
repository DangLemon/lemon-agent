...
def make_lemon_home(base: Path, journal_mode: str) -> Path:
    """Create an isolated LEMON_HOME whose config pins ``database.journal_mode``.
    ...
    """
    home = base / f"lemon-home-{journal_mode}"
