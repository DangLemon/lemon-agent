...
from lemon_cli.plugins import VALID_HOOKS, PluginManager
...
# tests/lemon_cli/test_lifecycle.py::test_finalize_session_closes_core_before_plugin_export.
@patch("lemon_cli.lifecycle.invoke_hook")
@patch("lemon_cli.lifecycle.finalize_session")
