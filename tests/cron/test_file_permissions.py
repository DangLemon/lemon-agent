...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("lemon_cli.config.get_config_path", return_value=config_path), \
             patch("lemon_cli.config.ensure_lemon_home"):
    ...
    def test_ensure_lemon_home_sets_0700(self):
        home = Path(self.tmpdir) / ".lemon-ai"
        with patch("lemon_cli.config.get_lemon_home", return_value=home):
