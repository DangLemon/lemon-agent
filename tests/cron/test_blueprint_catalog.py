...
the shared /blueprint command handler (lemon_cli/blueprint_cmd.py), and
the docs generator. Uses an isolated LEMON_HOME for anything that touches the
cron job store.
"""
...
class TestRenderers:
    ...
    def test_deeplink_shape(self):
        ...
        assert url.startswith("lemon://blueprint/morning-brief?")
