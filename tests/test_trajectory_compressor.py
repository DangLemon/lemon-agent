...
def test_import_loads_env_from_lemon_home(tmp_path, monkeypatch):
    home = tmp_path / ".lemon-ai"
    home.mkdir()
    (home / ".env").write_text("OPENROUTER_API_KEY=from-lemon-home\n", encoding="utf-8")
    ...
    assert os.getenv("OPENROUTER_API_KEY") == "from-lemon-home"
