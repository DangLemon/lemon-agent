"""Regression test: lemon update must not load cryptography eagerly."""
...
assert 'lemon_cli.secrets_cli' not in sys.modules, \\
...
"""
    ...
    def test_update_check_no_cryptography(self) -> None:
        """Running lemon update --check should NOT load cryptography._rust."""
        # Write a small script in the repo root so lemon_cli is importable,
