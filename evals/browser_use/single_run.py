...
The run gets a throwaway LEMON_HOME so no local config leaks in, and the
...
if _or_key:
    ...
    # Resolved by the orchestrator BEFORE LEMON_HOME is redirected to the
