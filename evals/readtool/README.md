...
benchmarked ten harnesses on hostile-file handling — and whose Lemon AI column
...
Every task runs the full Lemon AI agent (file + terminal + search toolsets)
...
Rules of engagement (from lemonbench discipline):
