...
Data file: $LEMON_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_LEMON_HOME = Path(os.environ.get("LEMON_HOME", Path.home() / ".lemon-ai"))
DATA_DIR = _LEMON_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
