...
def _state_dir() -> Path:
    ...
    # Default: $LEMON_HOME/watcher-state/, falling back to ~/.lemon-ai/watcher-state/.
    lemon_home = os.environ.get("LEMON_HOME") or str(Path.home() / ".lemon-ai")
    return Path(lemon_home) / "watcher-state"
