      ...
      let
        ...
        excludedDirs =
          ...
          jsWorkspaceTopDirs ++ [
            ...
            "nix"
            # Skills are shipped via LEMON_BUNDLED_SKILLS /
            # LEMON_OPTIONAL_SKILLS (see lemon-agent.nix), not via the
            ...
            # __init__.py) shipped via symlinks + LEMON_BUNDLED_LOCALES
            # / LEMON_OPTIONAL_MCPS, not via the wheel. Excluding them
