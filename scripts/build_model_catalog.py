#!/usr/bin/env python3
"""Build the Lemon AI Model Catalog — a centralized JSON manifest of curated models.
...
Lemon AI CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Lemon AI release.
...
# Ensure LEMON_HOME is set for imports that touch it at module level.
os.environ.setdefault("LEMON_HOME", os.path.join(os.path.expanduser("~"), ".lemon-ai"))

from lemon_cli.models import (  # noqa: E402
    OPENROUTER_MODELS,
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "lemon-agent repo",
            "docs": "https://github.com/DangLemon/lemon-agent/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
                    ...
                    "note": (
                        ...
                        'The entry labeled "default": true is the model Lemon AI '
