...
batch (tracker: [#77056](https://github.com/DangLemon/lemon-agent/issues/77056)).
...
- **Two arms, one variable.** `baseline` and `fixes` runs differ ONLY by
  ...
  Lemon AI home, same model, same tasks, same reps.
...
1. Create a dedicated Lemon AI home with credentials for the models under test:
   ...
   integration at it; no Lemon AI observability plugin needs to be enabled.
