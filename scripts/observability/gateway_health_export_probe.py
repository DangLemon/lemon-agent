...
def main() -> None:
    ...
    lemon_home = Path(tempfile.mkdtemp(prefix="lemon-otel-smoke-"))
    ...
    config = {
        "monitoring": {
            ...
            "gateway_health_export": {
                ...
                "resource_attributes": {
                    "service.name": "lemon-gateway-smoke",
    ...
    print(json.dumps({"lemon_home": str(lemon_home), "requests": len(rows), "paths": sorted(paths)}, indent=2))
