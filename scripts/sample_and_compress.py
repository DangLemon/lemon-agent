...
DEFAULT_DATASETS = [
    ...
    "DangLemon/lemon-agent-megascience-sft1",
    "DangLemon/lemon-agent-Thinking-GLM-4.7-SFT2",
    "DangLemon/lemon-agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-lemon-agent"
]
