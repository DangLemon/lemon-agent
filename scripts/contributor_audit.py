...
IGNORED_PATTERNS = [
    ...
    re.compile(r"^Lemon AI\s+(Agent|Audit)$", re.IGNORECASE),
    ...
    re.compile(r".*\[bot\]$", re.IGNORECASE),             # any GitHub [bot] suffix (lemon-seaeye[bot] etc.)
...
IGNORED_EMAILS = {
    ...
    "lemon@nousresearch.com",
    "lemon-audit@example.com",
    "nousbot@nousresearch.com",
    "lemon@habibilabs.dev",
    "omx@oh-my-codex.dev",
    "codex@openai.com",
