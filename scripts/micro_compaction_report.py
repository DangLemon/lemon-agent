#!/usr/bin/env python3
"""Summarize micro-compaction telemetry from Lemon AI logs.
...
With no LOGFILE, reads ``$LEMON_HOME/logs/agent.log`` (default ~/.lemon-ai).
...
def default_log() -> Path:
    home = os.environ.get("LEMON_HOME") or str(Path.home() / ".lemon-ai")
