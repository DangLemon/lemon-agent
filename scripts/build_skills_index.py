#!/usr/bin/env python3
"""Build the Lemon AI Skills Index — a centralized JSON catalog of all skills.
...
`lemon skills search/install` can use it without hitting the GitHub API.
...
# Ensure LEMON_HOME is set (needed by tools/skills_hub*.py imports)
...
def main():
    print("Building Lemon AI Skills Index...", flush=True)
