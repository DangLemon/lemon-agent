 ...
 *
 * Each entry is a key/value pair that lands in the packaged Lemon AI.app's
 ...
 * "Lemon AI wants to access Music" prompt unless the Info.plist disclaims it
 ...
 * user ("Lemon AI wants to access Music" when Lemon AI never touches the Music
