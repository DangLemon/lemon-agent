...
const SOURCE_CONFIG: Record<string, { icon: typeof Terminal; color: string }> =
  {
    ...
    lemon_flow: { icon: Play, color: "text-warning" },
...
const NO_MATCHING_SESSION_SOURCE = "__lemon_dashboard_no_matching_source__";
        ...
        const res = await fetch(api.exportSessionUrl(id, rowProfile(id)), {
          ...
          headers: {
            "X-Lemon-Session-Token":
              (window as unknown as { __LEMON_SESSION_TOKEN__?: string })
                .__LEMON_SESSION_TOKEN__ ?? "",
          },
        });
