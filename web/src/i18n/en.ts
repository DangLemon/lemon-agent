...
export const en: Translations = {
  ...
  status: {
    ...
    updateLemonConfirmMessage:
      "This runs lemon update and restarts the gateway when it finishes. Active sessions keep their prompt cache until then.",
    updateLemonConfirmNow: "Update now",
    updateLemonConfirmTitle: "Update Lemon AI?",
    updatingLemon: "Updating Lemon AI…",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update Lemon AI plugins (`lemon plugins` parity).",
    ...
    removeConfirm: "Remove this plugin from ~/.lemon-ai/plugins/?",
    removeHint: "Only user-installed plugins under ~/.lemon-ai/plugins can be removed.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.lemon-ai/skills/",
  ...
  config: {
    configPath: "~/.lemon-ai/config.yaml",
    filters: "Filters",
    sections: "Sections",
  ...
  env: {
    ...
    customHint: "Arbitrary environment variables stored in your .env that Lemon AI doesn't recognise. Use these to inject env vars for skills, MCP servers, or your own tooling.",
  ...
  achievements: {
    hero: {
      ...
      title: "Lemon AI Achievements",
      subtitle:
        "Collectible Lemon AI badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning Lemon AI session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run Lemon AI more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once Lemon AI sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "Lemon AI is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
    ...
    share: {
      ...
      tweet_text: "Just unlocked {tier_part}\"{name}\" in Lemon AI ☤",
    },
  },
