...
export interface Translations {
  ...
  status: {
    ...
    stopped: string;
    updateLemon: string;
    updateLemonConfirmMessage?: string;
    updateLemonConfirmNow?: string;
    updateLemonConfirmTitle?: string;
    updatingLemon: string;
  ...
  // ── Achievements plugin (plugins/lemon-achievements) ──
  achievements: {
    hero: {
      kicker: string;
      title: string;
