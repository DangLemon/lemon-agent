 ...
 *
 * Values mirror lemon_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the Lemon AI default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (Lemon AI' default when unset). */
