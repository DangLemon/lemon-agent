...
const STORAGE_KEY = "lemon-dashboard-theme";
...
const FONT_STORAGE_KEY = "lemon-dashboard-font";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `lemon_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "lemon-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-lemon-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-lemon-theme-font", "true");
