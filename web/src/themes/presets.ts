 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `lemon_cli/web_server.py`.
 */
...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "Lemon AI Teal",
  description: "Classic dark teal — the canonical Lemon AI look",
  palette: {
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "Lemon AI Teal (Large)",
  description: "Lemon AI Teal with bigger fonts and roomier spacing",
