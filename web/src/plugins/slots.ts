 ...
 * `window.__LEMON_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Lemon AI brand in the top bar
 ...
 *  `window.__LEMON_PLUGINS__.registerSlot(...)`.
 *
