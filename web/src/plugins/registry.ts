 ...
 *
 * Plugins call window.__LEMON_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__LEMON_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__LEMON_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__LEMON_PLUGIN_SDK__ = {
    ...
    // window.__LEMON_SESSION_TOKEN__ directly.
    authedFetch,
