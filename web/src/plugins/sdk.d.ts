/**
 * Lemon AI Dashboard Plugin SDK — typed contract (SPIKE)
 * ====================================================
 *
 * This is the public type surface for ``window.__LEMON_PLUGIN_SDK__`` and
 * ``window.__LEMON_PLUGINS__``, the globals the dashboard host exposes to
 ...
 * window.__LEMON_PLUGIN_SDK__`` because:
 ...
 *
 * Versioning: bump ``LemonPluginSDK["sdkVersion"]`` (and the
 ...
 *   - Ship as a published ``@lemon-ai/dashboard-plugin-sdk`` types package, or
 ...
 * of calling ``fetch`` with a hand-read ``window.__LEMON_SESSION_TOKEN__``.
 */
...
// ---------------------------------------------------------------------------
// Registry surface (window.__LEMON_PLUGINS__)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SDK surface (window.__LEMON_PLUGIN_SDK__)
// ---------------------------------------------------------------------------

export interface LemonPluginSDK {
...
declare global {
  interface Window {
    __LEMON_PLUGIN_SDK__?: LemonPluginSDK;
    __LEMON_PLUGINS__?: PluginRegistry;
  }
}
