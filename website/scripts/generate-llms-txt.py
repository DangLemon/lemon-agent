#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the Lemon AI docs site.
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use Lemon AI as a Python Library", None),
        ("guides/use-mcp-with-lemon", "Use MCP with Lemon AI", None),
        ("guides/use-voice-mode-with-lemon", "Use Voice Mode with Lemon AI", None),
        ("guides/use-soul-with-lemon", "Use SOUL.md with Lemon AI", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with Lemon AI"),
...
def emit_llms_index() -> str:
    ...
    lines: list[str] = []
    lines.append("# Lemon AI")
    lines.append("")
    lines.append(
        "> The self-improving AI agent built by Lemon Digital. A terminal-native "
    ...
    lines.append("")
    lines.append(
        "Install: `curl -fsSL https://raw.githubusercontent.com/DangLemon/"
        "lemon-agent/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/DangLemon/lemon-agent")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# Lemon AI — Full Documentation\n",
        (
            "This file is the entire Lemon AI documentation concatenated for LLM "
