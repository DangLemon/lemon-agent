  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What the Lemon AI community is actually building. Every tile
          below links to a real post, issue, video, or gist where someone
          describes how they use Lemon AI &mdash; scraped from X, GitHub, Reddit,
      ...
      <div className={styles.footer}>
        Built something with Lemon AI?{' '}
        <a
          href="https://github.com/DangLemon/lemon-agent/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
          Add your story to this page
        </a>{' '}
        by editing <code>userStories.json</code>, or open a{' '}
        <a href="https://github.com/DangLemon/lemon-agent/issues" target="_blank" rel="noopener noreferrer">
          GitHub Issue
        </a>{' '}
