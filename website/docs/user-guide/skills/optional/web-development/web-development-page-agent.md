...
| | |
|---|---|
| Source | Optional — install with `lemon skills install official/web-development/page-agent` |
...
- User wants **Lemon AI itself to drive a browser** → use Lemon AI' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
