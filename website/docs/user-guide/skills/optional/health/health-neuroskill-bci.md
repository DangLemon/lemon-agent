...
| | |
|---|---|
| Source | Optional — install with `lemon skills install official/health/neuroskill-bci` |
...
Connect Lemon AI to a running [NeuroSkill](https://neuroskill.com/) instance to read
