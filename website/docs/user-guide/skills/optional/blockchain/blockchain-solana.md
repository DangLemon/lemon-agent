...
| | |
|---|---|
| Source | Optional — install with `lemon skills install official/blockchain/solana` |
| Path | `optional-skills/blockchain\solana` |
| Version | `0.2.0` |
| Author | Deniz Alagoz (gizdusum), enhanced by Lemon AI |
| License | MIT |
...
Helper script path: ~/.lemon-ai/skills/blockchain/solana/scripts/solana_client.py
...
python ~/.lemon-ai/skills/blockchain/solana/scripts/solana_client.py stats
```
...
```bash
python ~/.lemon-ai/skills/blockchain/solana/scripts/solana_client.py \
...
```bash
python ~/.lemon-ai/skills/blockchain/solana/scripts/solana_client.py price BONK
python ~/.lemon-ai/skills/blockchain/solana/scripts/solana_client.py price JUP
python ~/.lemon-ai/skills/blockchain/solana/scripts/solana_client.py price SOL
python ~/.lemon-ai/skills/blockchain/solana/scripts/solana_client.py price DezXAZ8z7PnrnRJjz3wXBoRgixCa6xjnB7YaB1pPB263
```
