...
| | |
|---|---|
| Source | Optional — install with `lemon skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain\hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Lemon AI |
| License | MIT |
...
The script reads `${LEMON_HOME:-~/.lemon-ai}/.env` for two optional defaults:
...
Helper script: `~/.lemon-ai/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python ~/.lemon-ai/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${LEMON_HOME:-~/.lemon-ai}/.env`.
...
```bash
python ~/.lemon-ai/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python ~/.lemon-ai/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
