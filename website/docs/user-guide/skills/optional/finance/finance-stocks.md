...
| | |
|---|---|
| Source | Optional — install with `lemon skills install official/finance/stocks` |
| Path | `optional-skills/finance\stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Lemon AI |
| License | MIT |
...
```
SCRIPT=~/.lemon-ai/skills/finance/stocks/scripts/stocks_client.py
...
```
python ~/.lemon-ai/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
