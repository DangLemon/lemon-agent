...
| | |
|---|---|
| Source | Optional — install with `lemon skills install official/research/blogwatcher` |
...
## Working with Lemon AI tools (read this first)

`blogwatcher-cli` is the feed database; Lemon AI tools do the automation around it:
