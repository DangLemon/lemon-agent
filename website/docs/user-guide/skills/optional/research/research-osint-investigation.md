...
| | |
|---|---|
| Source | Optional — install with `lemon skills install official/research/osint-investigation` |
| Path | `optional-skills/research\osint-investigation` |
| Version | `0.1.0` |
| Author | Lemon AI (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
| License | MIT |
...
# $LEMON_OSINT_CACHE/icij/ (default: ~/.cache/lemon-osint/icij/).
...
# Set LEMON_OSINT_UA=your-app/1.0 (your@email) to identify yourself
