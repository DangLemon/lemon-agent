...
| | |
|---|---|
| Source | Optional — install with `lemon skills install official/research/qmd` |
...
| Related skills | [`obsidian`](/docs/user-guide/skills/bundled/note-taking/note-taking-obsidian), [`lemon-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-lemon-agent), [`arxiv`](/docs/user-guide/skills/bundled/research/research-arxiv) |
...
Lemon AI via the native MCP client. This is the preferred
...
Then configure Lemon AI to connect via HTTP:
