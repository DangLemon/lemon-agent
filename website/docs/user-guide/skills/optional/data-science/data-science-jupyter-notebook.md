...
| | |
|---|---|
| Source | Optional — install with `lemon skills install official/data-science/jupyter-notebook` |
...
| `execute_code` | One-shot scripts needing lemon tool access (web_search, file ops). Stateless. |
