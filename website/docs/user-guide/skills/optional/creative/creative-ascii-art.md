...
| | |
|---|---|
| Source | Optional — install with `lemon skills install official/creative/ascii-art` |
| Path | `optional-skills/creative\ascii-art` |
| Version | `4.0.0` |
| Author | 0xbyt4, Lemon AI |
| License | MIT |
...
```bash
python -m pyfiglet "LEMON" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=LEMON&font=Slant" | boxes -d stone
```
