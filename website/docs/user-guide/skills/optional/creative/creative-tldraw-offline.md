...
| | |
|---|---|
| Source | Optional — install with `lemon skills install official/creative/tldraw-offline` |
| Path | `optional-skills/creative\tldraw-offline` |
| Version | `1.0.0` |
| Author | Teknium + Lemon AI |
| License | MIT |
...
- **Agent skills installed in the app**: `Develop → Install Agent Skills`. The
  ...
  recipes below. (This Lemon AI skill mirrors that guidance for Lemon AI.)
