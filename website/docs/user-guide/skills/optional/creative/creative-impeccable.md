...
| | |
|---|---|
| Source | Optional — install with `lemon skills install official/creative/impeccable` |
...
> ships and verifies a Lemon AI-native skill bundle under `.lemon-ai/skills/`.
> `lemon skills install impeccable` pulls the current bundle live from that
