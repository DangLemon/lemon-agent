...
| | |
|---|---|
| Source | Optional — install with `lemon skills install official/productivity/shopify` |
...
4. Save to `${LEMON_HOME:-~/.lemon-ai}/.env`:
   ```
...
}' '{"input":{"title":"Test Hoodie","status":"DRAFT","vendor":"Lemon AI","productType":"Apparel","tags":["test"]}}'
```
