...
| [`lemon-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-lemon-agent) | Use, configure, theme, extend, and orchestrate Lemon AI. | `autonomous-ai-agents\lemon-agent` |
...
| [`lemon-agent-skill-authoring`](/docs/user-guide/skills/bundled/software-development/software-development-lemon-agent-skill-authoring) | Author in-repo SKILL.md files: frontmatter and structure. | `software-development\lemon-agent-skill-authoring` |
| [`inspecting-lemon-desktop-dom`](/docs/user-guide/skills/bundled/software-development/software-development-inspecting-lemon-desktop-dom) | Read the live Lemon AI desktop DOM/CSS over CDP. | `software-development\inspecting-lemon-desktop-dom` |
