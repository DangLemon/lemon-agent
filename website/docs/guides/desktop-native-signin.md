...
description: "How the Lemon AI app signs in to a gated gateway using your system browser and PKCE — no embedded webview, no session cookies"
---

# Desktop Native Sign-In (RFC 8252)

When the Lemon AI app connects to a **gated gateway** (a hosted or
...
For Lemon AI specifically, native sign-in means:
...
- [Run Lemon AI with Nous Portal](./run-lemon-with-nous-portal.md)
