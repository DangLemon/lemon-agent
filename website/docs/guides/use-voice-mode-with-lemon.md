---
sidebar_position: 8
title: "Use Voice Mode with Lemon AI"
description: "A practical guide to setting up and using Lemon AI voice mode across CLI, Telegram, Discord, and Discord voice channels"
---

# Use Voice Mode with Lemon AI
...
- you want Lemon AI sitting in a Discord voice channel for live conversation
...
There are really three different voice experiences in Lemon AI.
...
## Step 1: make sure normal Lemon AI works first
...
Lemon AI supports both local and cloud speech stacks.
...
4. Lemon AI transcribes and responds
...
- asking Lemon AI to structure your thoughts in real time

#### Accessibility / low-typing sessions

If typing is inconvenient, voice mode is one of the fastest ways to stay in the full Lemon AI loop.

## Tuning CLI behavior

### Silence threshold

If Lemon AI starts/stops too aggressively, tune:
...
Lemon AI stays a normal chat bot, but can speak replies.
...
- you want Lemon AI to function like a portable research or ops assistant
...
Lemon AI joins a Discord VC, listens to user speech, transcribes it, runs the normal agent pipeline, and speaks replies back into the channel.
...
- Lemon AI detects speech boundaries
- transcripts are posted in the associated text channel
- Lemon AI responds in text and audio
...
1. get text Lemon AI working
2. run `lemon setup tts` to enable voice support
