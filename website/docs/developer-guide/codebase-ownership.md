...
| Model providers & transports | `agent/transports/`, `plugins/model-providers/`, `lemon_cli/models.py` | [Adding Providers](adding-providers.md), [Model Provider Plugins](model-provider-plugin.md), [Provider Runtime](provider-runtime.md) |
...
| CLI | `lemon_cli/` | [Extending the CLI](extending-the-cli.md) |
| Plugins system | `plugins/` | [Build a Lemon AI Plugin](plugins/index.md) |
...
| Session storage | `lemon_state.py`, `lemon_state_*.py` | [Session Storage](session-storage.md) |
