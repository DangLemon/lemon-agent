/**
 * Canonical Lemon AI skin — the theme SDK's cross-surface contract.
 *
 * A skin is authored once as YAML in `$LEMON_HOME/skins/<name>.yaml` (or a
 * built-in), resolved by the Python skin engine (`lemon_cli/skin_engine.py`),
 ...
 *   • CLI     → `lemon_cli/skin_engine` → prompt_toolkit / Rich styles (Python)
 *
