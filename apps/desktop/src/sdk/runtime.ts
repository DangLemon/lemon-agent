 ...
 * plugins resolve `@lemon-ai/plugin-sdk` through the vite alias; RUNTIME-loaded
...
const GLOBALS = {
  __LEMON_PLUGIN_SDK__: sdk,
  __LEMON_REACT__: React,
  __LEMON_REACT_JSX__: jsxRuntime,
  __LEMON_REACT_JSX_DEV__: jsxDevRuntime
} as const
...
export function sdkImportMap(): Record<string, string> {
  cached ??= {
    '@lemon-ai/plugin-sdk': shimUrl('__LEMON_PLUGIN_SDK__'),
    'react/jsx-dev-runtime': shimUrl('__LEMON_REACT_JSX_DEV__'),
    'react/jsx-runtime': shimUrl('__LEMON_REACT_JSX__'),
    react: shimUrl('__LEMON_REACT__')
  }
