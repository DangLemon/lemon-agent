...
export const en: Translations = {
  ...
  uninstall: {
    ...
    heading: 'Uninstall Lemon AI',
    intro: 'Choose how much to remove. The app closes to finish the job; reopen the installer any time to come back.',
    loading: "Checking what's installed…",
    running: 'Uninstalling…',
    startError: 'Uninstall could not start.',
    options: {
      gui: {
        title: 'Uninstall Chat GUI only',
        description: 'Remove this desktop app. The Lemon AI agent, your config, and chats all stay.',
        consequence: 'the desktop Chat GUI (this app and its data)'
      },
      lite: {
        title: 'Uninstall GUI + agent, keep my data',
        description: 'Remove the app and the Lemon AI agent, but keep config, chats, and secrets for a future reinstall.',
        consequence: 'the Chat GUI and the Lemon AI agent (config, chats, and secrets are kept)'
      },
      full: {
        title: 'Uninstall everything',
        description: 'Remove the app, the agent, and all user data — config, chats, scheduled jobs, secrets, logs.',
        consequence: 'EVERYTHING — the Chat GUI, the Lemon AI agent, and all of your config, chats, secrets, and logs'
      }
    }
  },
  ...
  boot: {
    ...
    steps: {
      ...
      loadingSettings: 'Loading Lemon AI settings',
      loadingSessions: 'Loading recent sessions',
      retryingRemoteBackend: 'Reconnecting to the remote Lemon AI backend…',
      startingDesktopConnection: 'Starting desktop connection',
      startingLemonDesktop: 'Starting Lemon AI…'
    },
    errors: {
      backgroundExited: 'Lemon AI background process exited.',
      backgroundExitedDuringStartup: 'Lemon AI background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Lemon AI backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateLemon: 'Update Lemon AI',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Lemon AI.',
    ...
    native: {
      ...
      inputBody: 'Lemon AI is waiting for your response.',
      turnDoneTitle: 'Lemon AI finished',
      turnDoneBody: '',
  ...
  sendDiagnostics: {
    ...
    failedHint:
      'You can also run `lemon debug share --nous` from a terminal, or `lemon debug share --local` to print the report without uploading.',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Lemon AI defaults?',
    ...
    aiConnection: {
      title: 'AI Connection',
      intro: 'Change where Lemon AI sends requests and the model you want to use.',
      savedConnections: 'Saved connections',
      addConnection: 'Add connection',
      currentBadge: 'In use',
      selectedForEditing: 'Selected for editing',
      savedKey: 'Access key saved',
      editTitle: 'Edit connection',
      newTitle: 'Add connection',
      nameLabel: 'Connection name',
      namePlaceholder: 'Company AI',
      urlLabel: 'Server address',
      urlHelp: 'Use the full base URL for an OpenAI-compatible service, including any custom path.',
      keyLabel: 'Access key (API key)',
      keyAriaLabel: 'API key',
      keyExistingPlaceholder: 'Leave blank to keep the saved key',
      keyNewPlaceholder: 'Optional',
      keyExistingHelp: 'For saved connections, leaving this blank keeps the existing key.',
      keyNewHelp: 'Leave blank if this service does not require a key.',
      modelLabel: 'Model',
      modelPlaceholder: 'model-name',
      modelHelp: 'Use the model name from your AI service. You can type it manually.',
      saveAndUse: 'Save and use',
      testConnection: 'Test connection',
      cancelChanges: 'Cancel changes',
      saveScope: 'Saved connections are used for new conversations. Existing conversations may keep their selected model.',
      loadFailed: 'Could not load AI connections.',
      saveFailed: 'Could not save this connection. Check the fields and try again.',
      saved: 'Saved. New conversations will use this connection.',
      invalidUrl: 'Enter a full server address starting with http:// or https://.',
      requiredFields: 'Fill in the connection name, server address, and model.',
      validationReachable: 'The AI service answered the model list request.',
      validationModels: count =>
        `Found ${count} ${count === 1 ? 'model' : 'models'}. You can choose one or type a model name manually.`,
      validationFailed: 'Could not reach the AI service. Check the address and key, then try again.'
    },
    plugins: {
      ...
      agent: {
        title: 'Agent plugins',
        blurb:
          'Plugins you installed into the Lemon AI backend — tools, skills, MCP servers, hooks, and slash commands. Portable ones are Agent Plugins packages (skills + MCP bundles that work in other agents too). Toggles apply to new sessions.',
        ...
        updateBackendToManage: 'Update the Lemon AI backend to manage this plugin from Desktop.',
      ...
      installModal: {
        ...
        agentTargetLocal: profile => `Installs into the ${profile} backend (~/.lemon-ai/plugins/)`,
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Lemon AI is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Lemon AI asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Lemon AI was in the background.'
        },
        turnError: {
          label: 'Turn failed',
        ...
        plugin: {
          ...
          description: 'A desktop plugin sent a notification while Lemon AI was in the background.'
        }
      },
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Lemon AI follow your system setting.',
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and Lemon AI can react to yours.',
      tipsTitle: 'In-App Tips',
      tipsDesc:
        'A small bubble pointing at one part of the app, shown occasionally while idle and by Lemon AI when it helps. Closing one retires it for good.',
      tipsReset: (count: number) => `Bring back ${count} closed ${count === 1 ? 'tip' : 'tips'}`,
      toursTitle: 'Guided Tours',
      toursDesc: 'Let Lemon AI walk you through the app, dimming the screen and spotlighting each step.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Lemon AI is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Lemon AI, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Lemon AI checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Lemon AI configuration...',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening Lemon AI.',
    ...
    connections: {
      ...
      intro: 'Manage this device and every Lemon AI gateway it can reach through remote, SSH, or Cloud connections.',
      stagedNote:
      ...
      updateSkippedCloud: 'Managed by Lemon AI Cloud',
      kindLocal: 'Local',
      kindRemote: 'Remote gateway',
      kindCloud: 'Lemon AI Cloud',
      kindSsh: 'SSH',
      kindLocalDesc: 'The Lemon AI runtime managed by this app.',
      kindRemoteDesc: 'A Lemon AI gateway reachable over HTTP(S) — LAN, Tailscale, or the internet.',
      kindCloudDesc: 'A hosted instance discovered through your Lemon AI Cloud account.',
      kindSshDesc: 'A Lemon AI install reached over SSH.',
      labelTitle: 'Name',
      ...
      headersDesc:
        'Sent with every HTTP and WebSocket request to this gateway — for access proxies such as Cloudflare Access (CF-Access-Client-Id / CF-Access-Client-Secret). Values are stored encrypted. Headers Lemon AI manages (Authorization, Cookie, Host…) are ignored.',
      ...
      cloudAddHint:
        'Tip: signing in under Lemon AI Cloud above discovers your agents automatically — use this form only to register a known instance URL by hand.',
    ...
    gateway: {
      ...
      intro:
        'Local by default. Use remote when this app should drive a Lemon AI backend elsewhere. Gateway connections are machine-level; profiles are discovered from the gateways you connect.',
      envOverrideTitle: 'Environment variables are controlling this desktop session.',
      envOverrideDesc:
        'Unset LEMON_DESKTOP_REMOTE_URL and LEMON_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      modeTitle: 'Connection mode',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Lemon AI backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote Lemon AI backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'Lemon AI Cloud',
      cloudDesc: 'Sign in once to Lemon AI Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'Lemon AI Cloud',
      cloudSignIn: 'Sign in to Lemon AI Cloud',
      cloudSignedIn: 'Signed in to Lemon AI Cloud',
      cloudNeedsSignIn: 'Sign in to Lemon AI Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your Lemon AI Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'Lemon AI Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of Lemon AI Cloud',
      cloudSignedOutMessage: 'Cleared the Lemon AI Cloud session.',
      ...
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /lemon.',
      ...
      restartingMessage: 'Lemon AI will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Lemon AI ${version}` : ''}`,
      ...
      sshDesc:
        'Lemon AI is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshLemonPathTitle: 'Lemon AI path (optional)',
      sshLemonPathDesc: 'Full path to the remote lemon binary. Blank = auto-detect.',
      sshLemonPathPlaceholder: 'auto-detect',
      sshTestConnection: 'Test SSH',
      sshConnect: 'Connect',
      sshButtonsHint: 'Save applies on the next launch. Connect reconnects now.',
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — Lemon AI found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — Lemon AI runs ssh non-interactively.',
      sshErrHostKey:
      ...
      sshErrUpdateRequired: 'Update Lemon AI on the remote host before connecting with Desktop SSH.',
    ...
    mcp: {
      ...
      deepLinkDescription:
        'A link asked to add this MCP server to Lemon AI. Review the exact configuration below — it comes from the link, not from Lemon AI.',
    ...
    localModels: {
      ...
      runtimeInstalledDetail: (tag, backend) =>
        `Build ${tag}, ${backend} backend. Lemon AI starts and manages the server for you.`,
      ...
      upToDateDetail: (tag, backend) => `Running llama.cpp ${tag} (${backend}) — the latest build Lemon AI ships.`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Lemon AI runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point Lemon AI at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
    ...
    toolsets: {
      ...
      browserRealProfile: {
        ...
        prompt: {
          ...
          body: 'Let Lemon AI browse with a snapshot of your default browser profile, so sites open already signed in.',
  ...
  skills: {
    ...
    edit: 'Edit',
    archive: 'Archive',
    archiveSkillConfirmDescription: 'The skill is archived and can be restored with `lemon curator restore`.',
    archiveSkillConfirmTitle: name => `Archive ${name}?`,
    archiveSkillFailed: 'Archive failed',
    skillArchivedTitle: 'Skill archived',
    skillArchivedMessage: 'Restorable via lemon curator restore.',
  ...
  starmap: {
    ...
    emptyDesc: 'As Lemon AI builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Lemon AI to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Lemon AI to generate pets.',
      backgroundHint: 'You can close this — Lemon AI will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Lemon AI desktop' },
    ...
    lemonActiveSessions: (version, count) => `Lemon AI ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@lemon:example.org' },
  ...
  profiles: {
    ...
    remoteOverride: {
      ...
      description: 'Sessions in this profile will run on the remote Lemon AI you point it at, instead of this computer.',
      urlLabel: 'Remote address',
      urlPlaceholder: 'https://lemon.example.com',
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Lemon AI environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    modelImpact: {
      ...
      saveFailed: 'Lemon AI did not save that model change.',
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Lemon AI will run it and deliver results to the destination you pick.',
  ...
  artifacts: {
    ...
    partialLoadMessage: (skipped, total) => `Skipped ${skipped} of ${total} recent sessions while indexing artifacts.`,
    safeLimitDetail: count => `${count} exceeded the safe transcript load limit.`,
    unreadableDetail: count => `${count} could not be read.`,
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Lemon AI backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Lemon AI. Files, git repos, and worktrees stay untouched.',
      ...
      worktreeStaleBackend:
        'Update the Lemon AI backend to create worktrees over this remote connection — it predates the git worktree API.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Lemon AI...',
    placeholderReconnecting: 'Reconnecting to Lemon AI…',
    placeholderFollowUp: 'Send follow-up',
    newSessionPlaceholders: [
      'What are we building?',
      'Give Lemon AI a task',
      "What's on your mind?",
    ...
    attachUrlDesc: 'Lemon AI will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Lemon AI to open PR',
  ...
  updates: {
    ...
    unsupportedMessage: 'This version of Lemon AI can’t update itself from inside the app.',
    ...
    manualBody: 'You installed Lemon AI from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Lemon AI will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Lemon AI desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Lemon AI updater takes over in its own window and reopens Lemon AI automatically when it’s done. Please don’t reopen Lemon AI yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Lemon AI reconnects automatically when it’s back.',
    ...
    blockerBody:
      'Lemon AI needs to stop these local previews before updating. This will not modify or delete your files.',
    foreignBlockerTitle: 'Close other processes to update Lemon AI',
    foreignBlockerBody:
      'Lemon AI can’t safely close these processes automatically. Close the app, terminal, or service that owns each one, then try the update again.',
    mixedBlockerBody:
      'Lemon AI can close the local previews listed below. Other processes must be closed manually before the update can continue.',
  ...
  install: {
    ...
    oneTimeTitle: 'Lemon AI needs a one-time install',
    ...
    setupChoiceTitle: 'Set up Lemon AI',
    setupChoiceDesc:
      'Connect this app to a Lemon AI gateway you already run, or install Lemon AI locally on this computer.',
    connectExistingTitle: 'Connect to existing Lemon AI',
    ...
    installLocalTitle: 'Install Lemon AI locally',
    installLocalDesc: 'Download Lemon AI, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart Lemon AI and try again.',
    remoteSetupTitle: 'Connect to existing Lemon AI',
    remoteSetupDesc: 'Enter your gateway URL. Lemon AI will detect whether it needs a token or browser sign-in.',
    remoteUrlTitle: 'Gateway URL',
    remoteUrlDesc: 'Use the base URL of the Lemon AI gateway, including https:// when remote.',
    remoteUrlPlaceholder: 'https://gateway.example.com/lemon',
    probing: 'Detecting gateway authentication...',
    probeError: 'Could not reach that Lemon AI gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
    ...
    settingUpTitle: 'Setting up Lemon AI',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Lemon AI CLI or desktop instance is running. Stop any running Lemon AI instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The Lemon AI installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Lemon AI",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Lemon AI is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Lemon AI…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Lemon AI',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Lemon AI at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Lemon AI connects automatically',
    ...
    authorizeThere: 'Authorize Lemon AI there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Lemon AI there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Lemon AI v${version}`,
      backendVersion: version => `Backend v${version}`,
      clientLabel: version => `client v${version}`,
      connectionSsh: host => `SSH: ${host}`,
      connectionRemote: host => `Remote: ${host}`,
      connectionCloud: host => `Cloud: ${host}`,
      connectionCloudTooltip: host => `Lemon AI Cloud · ${host}`,
      ...
      gatewayNeedsAiConnection: 'No AI connection ready',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Lemon AI will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Lemon AI is restarting...',
      askRestart: 'Ask Lemon AI to restart the server',
      lookingRestart: taskId => `Lemon AI is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Lemon AI is working in the background. Watch the preview console for progress.',
      ...
      blankPageBody: 'Type an address above to browse, or ask Lemon AI to open a page.',
      finishedRestarting: message => `Lemon AI finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Lemon AI could not restart the server.',
      stillWorking:
        'Lemon AI is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Lemon AI is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Lemon AI gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.lemon-ai/config.yaml). Lemon AI won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Lemon AI needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Lemon AI needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Lemon AI to use Save Image.',
    restartToSaveImages: 'Restart Lemon AI to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `lemon gateway` running?'
    }
  },
  ...
  tips: {
    ...
    items: {
      ...
      skills: {
        title: 'Teach it once',
        text: 'Skills are folders of instructions Lemon AI loads when the work calls for them.'
      },
      messaging: {
        title: 'Lemon AI away from your desk',
        text: 'Connect Telegram, Discord, Slack and more — same agent, same memory.'
      },
      artifacts: {
        title: 'Everything Lemon AI made',
      ...
      profiles: {
        ...
        text: 'Each one is its own Lemon AI — own keys, own memory, own sessions.'
      },
      'composer-mentions': {
