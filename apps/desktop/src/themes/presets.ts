...
/**
 * Nous — the canonical Lemon AI desktop identity, forked from the GitHub VS Code
 ...
 * extension yourself.
 *
 * Typography stays Lemon AI's own: a VS Code theme carries no font opinion, and
...
/**
 * Nous — the canonical Lemon AI desktop identity: GitHub's chrome carrying Nous
