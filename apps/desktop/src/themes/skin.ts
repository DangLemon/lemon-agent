/**
 * Lemon AI skin → DesktopTheme converter.
 *
 * A "skin" is the CLI/TUI theme unit: a YAML file in `$LEMON_HOME/skins/` (or a
 * built-in) resolved by `lemon_cli/skin_engine.py` and pushed to every surface
 ...
 * skin Lemon AI authors from a prompt lights up all three surfaces from one file.
 *
...
import type { LemonSkin, SkinColors } from '@lemon-ai/shared/skin'
 ...
 */
export function skinToDesktopTheme(skin: LemonSkin): DesktopTheme | null {
