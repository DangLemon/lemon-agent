...
function identityForConnection(connection: LemonConnection | null): string {
  if (!connection) {
    return ''
  }
...
export function syncCronModelImpactConnection(connection: LemonConnection | null): void {
