...
describe('remoteHostLabel', () => {
  it('keeps a non-default port and drops default ones', () => {
    expect(remoteHostLabel('https://lemon.example.com:8443/x')).toBe('lemon.example.com:8443')
    expect(remoteHostLabel('https://lemon.example.com:443')).toBe('lemon.example.com')
    expect(remoteHostLabel('http://lemon.example.com:80')).toBe('lemon.example.com')
  })
