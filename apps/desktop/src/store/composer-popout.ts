...
const POPOUT_STORAGE_KEY = 'lemon.desktop.composerPopout.zones.v1'
const POPOUT_GESTURES_ENABLED_STORAGE_KEY = 'lemon.desktop.composerPopout.gesturesEnabled'
...
const LEGACY_ENABLED_KEY = 'lemon.desktop.composerPopout.enabled'
const LEGACY_POSITION_KEY = 'lemon.desktop.composerPopout.position'
