...
function installBridge(
  openSessionWindow?: Window['lemonDesktop']['openSessionWindow'],
  openWindow?: Window['lemonDesktop']['openWindow'],
  openBrowserWindow?: Window['lemonDesktop']['openBrowserWindow']
) {
