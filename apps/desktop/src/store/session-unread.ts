...
function rehydrateFromDiskOnce(): void {
  ...
  try {
    const rawSeen = readKey('lemon.desktop.sessionSeenCounts')
    ...
    const rawMarkers = readKey('lemon.desktop.unreadFinishedSessions')
