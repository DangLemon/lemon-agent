...
export interface PetInfo {
  ...
  // the Lemon AI "run" activity state uses the in-place running row).
 ...
 * LEMON_HOME — so every pet RPC carries this. The gateway no-ops it for the
 ...
 */
const ROAM_KEY = 'lemon.desktop.pet-roam.v1'
