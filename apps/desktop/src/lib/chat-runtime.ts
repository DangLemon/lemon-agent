...
import type { ModelOptionsResponse, SessionInfo } from '@/types/lemon'
 ...
 *
 * Only the leading status prefix (e.g. "Lemon AI is thinking...") and the
 ...
 *  resolved comment as JSON (LemonPrComment shape); a malformed payload falls
