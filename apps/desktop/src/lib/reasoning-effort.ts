...
/** Lemon AI' reasoning levels, in ascending order — mirrors the backend's
 *  VALID_REASONING_EFFORTS (lemon_constants.py). `none` is not a level: it's
...
/** Lemon AI' built-in level when neither the surface nor the profile config
