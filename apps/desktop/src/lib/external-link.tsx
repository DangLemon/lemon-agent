...
const SKIP_PROTO_RE = /^(?:file|data|mailto|javascript|blob|chrome|about|lemon):/i
...
export function fetchLinkTitle(url: string): Promise<string> {
  ...
  const bridge = typeof window === 'undefined' ? undefined : window.lemonDesktop?.fetchLinkTitle
...
export function openExternalLink(href: string): void {
  if (href) {
    void window.lemonDesktop?.openExternal?.(href)
  }
}
 ...
 * doesn't cost a context switch out of Lemon AI, and it is the surface the agent
