...
const relaySource = readFileSync(join(process.cwd(), 'src/plugins/lemon-bots/relay.ts'), 'utf8')
const repoRoot = join(process.cwd(), '..', '..')
const configDefaults = readFileSync(join(repoRoot, 'lemon_cli/config_defaults.py'), 'utf8')
