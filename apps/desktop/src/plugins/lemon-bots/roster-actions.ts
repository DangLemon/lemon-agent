...
import { ackStoredSessionId, atom, haptic, host, markSessionUnreadFinished } from '@lemon-ai/plugin-sdk'
 ...
 *  (lemon-agent#90102) and are discarded. Without `canonical_session` (older
