 ...
 *    the primary profile surfaced as @default instead of @lemon;
 ...
 *    kanban/tool workers count too (lemon-agent#90268): a profile grinding
...
describe('previewKind classifies a roster preview', () => {
  ...
  it('surfaces the primary profile as @lemon, never @default (#89484)', () => {
    expect(fromBot("Message from agent 'default': deploy is green")).toBe('lemon')
