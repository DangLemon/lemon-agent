...
import { type PluginLocaleBundles, type PluginTranslate, usePluginI18n } from '@lemon-ai/plugin-sdk'
...
const en: BotsMessages = {
  roster: {
    ...
    rosterUnavailable: reason =>
      `Roster unavailable: ${reason}. If your gateway predates profiles.list, update Lemon AI and restart the gateway.`,
    waitingForGateway:
  ...
  bot: {
    ...
    skillsNeedNewerDesktop: 'Skills need a newer Lemon AI.',
    openAnotherChatUnsupported: 'Update Lemon AI to open another Bot chat.',
    remoteConnectionsUnsupported: 'Update Lemon AI to chat with bots on other connections.',
...
const ja: BotsMessages = {
  roster: {
    ...
    retryNow: '今すぐ再試行',
    rosterUnavailable: reason =>
      `名簿を取得できません: ${reason}。ゲートウェイが profiles.list より前の場合は、Lemon AI を更新してゲートウェイを再起動してください。`,
  ...
  bot: {
    ...
    skillsNeedNewerDesktop: 'スキルを使うには Lemon AI の更新が必要です。',
    openAnotherChatUnsupported: '別のボットチャットを開くには Lemon AI を更新してください。',
    remoteConnectionsUnsupported: '他の接続上のボットとチャットするには Lemon AI を更新してください。',
...
const zh: BotsMessages = {
  roster: {
    ...
    unavailable: '不可用',
    retryNow: '立即重试',
    rosterUnavailable: reason => `无法获取名单：${reason}。如果网关早于 profiles.list，请更新 Lemon AI 并重启网关。`,
  ...
  bot: {
    ...
    skillsNeedNewerDesktop: '技能需要更新版 Lemon AI。',
    openAnotherChatUnsupported: '请更新 Lemon AI 以打开另一个机器人聊天。',
    remoteConnectionsUnsupported: '请更新 Lemon AI 以与其他连接上的机器人聊天。',
    chatEmpty: '说点什么开始吧。',
    kickoff: '你好，介绍一下你自己吧！'
  },
  avatar: {
...
const zhHant: BotsMessages = {
  roster: {
    ...
    unavailable: '不可用',
    retryNow: '立即重試',
    rosterUnavailable: reason => `無法取得名單：${reason}。如果閘道早於 profiles.list，請更新 Lemon AI 並重新啟動閘道。`,
  ...
  bot: {
    ...
    skillsNeedNewerDesktop: '技能需要更新版 Lemon AI。',
    openAnotherChatUnsupported: '請更新 Lemon AI 以開啟另一個機器人聊天。',
    remoteConnectionsUnsupported: '請更新 Lemon AI 以與其他連線上的機器人聊天。',
    chatEmpty: '說點什麼開始吧。',
    kickoff: '你好，介紹一下你自己吧！'
  },
  avatar: {
...
export function useBots(): BotsText {
  const t = usePluginI18n('lemon-bots')
