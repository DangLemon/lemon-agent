 ...
 * renderer process. The @lemon-ai/plugin-sdk host is mocked: notify/navigate
 * calls are asserted, never really executed.
 */

import type { PluginRestOptions } from '@lemon-ai/plugin-sdk'
