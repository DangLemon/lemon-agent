 ...
 * `<lemon home>/desktop-plugins/*` disk door — incl. agent-written ones),
...
const DECISIONS_KEY = 'lemon.desktop.pluginDecisions.v2'
const LEGACY_DISABLED_KEY = 'lemon.desktop.disabledPlugins.v1'
