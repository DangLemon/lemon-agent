...
import type { StarmapEdge, StarmapGraph, StarmapNode } from '@/types/lemon'
...
const VERSION = 3
const PREFIX = 'HML' // "Lemon AI Memory Loadout" — namespaces our codes like WoW's leading bytes.
