...
const TAKEOVER_KEY = 'lemon.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which Lemon AI can't clear via the API — the user
 *  sees exactly what runs instead of Lemon AI silently deleting their creds. */
