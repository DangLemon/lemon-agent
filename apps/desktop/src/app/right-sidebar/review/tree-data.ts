import type { LemonReviewFile } from '@/global'
...
export function buildReviewFlatList(files: LemonReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: LemonReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
