...
import { type DroppedFile, extractDroppedFiles, LEMON_PATHS_MIME } from './use-composer-actions'
...
const dragKindOf = (event: ReactDragEvent): DragKind =>
  dragHasAttachments(event.dataTransfer, LEMON_PATHS_MIME) ? 'files' : null
