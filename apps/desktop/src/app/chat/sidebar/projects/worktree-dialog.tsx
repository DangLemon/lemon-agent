...
import type { LemonGitBranch } from '@/global'
...
const branchActionLabel = (branch: LemonGitBranch, copy: BranchActionCopy) => {
...
export function WorktreeDialog() {
  ...
  const [branches, setBranches] = useState<LemonGitBranch[]>([])
  ...
  const convert = async (branch: LemonGitBranch) => {
    if (pending || !repoPath || !branch) {
      return
    }
