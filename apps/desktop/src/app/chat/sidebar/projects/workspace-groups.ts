...
import type { ProjectInfo, SessionInfo } from '@/lemon'
 ...
 * repo shows its branches/worktrees even when they have no Lemon AI sessions yet.
...
export function mergeRepoWorktreeGroups(
  ...
  discoveredWorktrees?: LemonGitWorktree[]
): SidebarSessionGroup[] {
