...
const FOCUS_EVENT = 'lemon:composer-focus'
const INSERT_EVENT = 'lemon:composer-insert'
const ATTACH_IMAGES_EVENT = 'lemon:composer-attach-images'
const INSERT_REFS_EVENT = 'lemon:composer-insert-refs'
const SUBMIT_EVENT = 'lemon:composer-submit'
const VOICE_TOGGLE_EVENT = 'lemon:composer-voice-toggle'
const MODEL_MENU_EVENT = 'lemon:composer-model-menu'
