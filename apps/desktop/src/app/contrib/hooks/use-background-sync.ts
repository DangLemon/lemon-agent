...
import { getLatestSessionMessages, type ProfileScope } from '@/lemon'
...
interface BackgroundSyncParams {
  ...
  refreshLemonConfig: () => Promise<unknown> | unknown
...
export function useBackgroundSync({
  ...
  }, [activeSessionId, freshDraftReady, gatewayState, refreshCurrentModel, refreshLemonConfig])
}
