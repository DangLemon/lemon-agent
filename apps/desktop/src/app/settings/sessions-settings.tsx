...
import type { LemonConfigRecord, SessionInfo } from '@/types/lemon'
...
// / Program Files), which buried any files Lemon AI wrote there.
function DefaultProjectDirSetting() {
  ...
  useEffect(() => {
    ...
    // / Storybook / non-Electron context `window.lemonDesktop` is
    ...
    const settings = window.lemonDesktop?.settings
