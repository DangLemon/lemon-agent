...
import { saveMemoryProviderConfig } from '@/lemon'
import { ExternalLink, Loader2, Save, SlidersHorizontal } from '@/lib/icons'
import { notify, notifyError } from '@/store/notifications'
import { $activeGatewayProfile } from '@/store/profile'
import type { MemoryProviderConfig, MemoryProviderField } from '@/types/lemon'
          ...
          {config.docs_url && (
            <a
              ...
              onClick={event => {
                ...
                void window.lemonDesktop?.openExternal?.(config.docs_url)
              }}
              rel="noreferrer"
              target="_blank"
            >
