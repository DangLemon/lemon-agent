...
function fontFamilyFromConfig(config: LemonConfigRecord): string {
...
export function TerminalFontSetting() {
  ...
  const { data: loadedConfig } = useLemonConfigRecord()
  ...
  const [staleConfig, setStaleConfig] = useState<LemonConfigRecord | null>(null)
  ...
  useEffect(() => {
    ...
    // holds — successful saves write it back via setLemonConfigCache, so
        ...
        <div className="mt-3 space-y-2">
          <div className="flex items-center gap-3">
            <Input
              ...
              className="flex-1"
              disabled={draft === null}
              list="lemon-terminal-font-families"
          ...
          <datalist id="lemon-terminal-font-families">
