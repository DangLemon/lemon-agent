...
export const LEMON_CONTEXT_MENU_TRIGGER_ATTR = 'data-lemon-context-menu-trigger'

function ContextMenuTrigger({ ...props }: React.ComponentProps<typeof ContextMenuPrimitive.Trigger>) {
  return (
    <ContextMenuPrimitive.Trigger data-slot="context-menu-trigger" {...props} data-lemon-context-menu-trigger="" />
  )
}
