...
const STORAGE_KEY = 'lemon.desktop.layoutTree.v2'

writeKey('lemon.desktop.layoutTree.v1', null)
 ...
 */
export const $activePresetId = atom<string>(readKey('lemon.desktop.layoutPreset.active') ?? 'default')

export function markActivePreset(id: string) {
  $activePresetId.set(id)
  writeKey('lemon.desktop.layoutPreset.active', id)
}
 ...
 */
const DISMISSED_KEY = 'lemon.desktop.dismissedPanes.v1'
...
const PANE_SHARE_KEY = 'lemon.desktop.paneShare.v1'
...
const HIDDEN_STRIP_TAB_KEY = 'lemon.desktop.hiddenStripTabs.v1'
...
writeKey('lemon.desktop.paneDockHeals.v1', null)
...
if ((import.meta.env.DEV || import.meta.env.VITE_PERF_PROBE === '1') && typeof window !== 'undefined') {
  ;(window as unknown as Record<string, unknown>).__LEMON_LAYOUT_TREE__ = {
    close: closeTreePane,
