...
// (#73044). Exercises the REAL lemon + store/gateway + store/profile chain:
...
const { pluginSocket, setApiRequestConnection, setApiRequestProfile } = await import('@/lemon')
...
const conn = (over: Partial<LemonConnection> = {}): LemonConnection =>
  ({
    authMode: 'oauth',
