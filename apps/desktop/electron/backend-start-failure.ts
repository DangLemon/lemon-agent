 ...
 * startLemon() re-throw the cached error without re-attempting the connect —
...
/**
 * Whether a startLemon() failure should latch into `backendStartFailure`.
 ...
 * Every subsequent `getConnection`/`api` call re-runs `startLemon`, re-emits
