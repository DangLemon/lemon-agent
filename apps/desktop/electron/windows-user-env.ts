...
// even though a fresh shell — and the Lemon AI CLI — sees it immediately. The
// desktop's LEMON_HOME resolution relies on process.env, so that stale-snapshot
// gap silently sends the backend to the default %LOCALAPPDATA%\Lemon AI. Reading
...
//       LEMON_HOME    REG_SZ    F:\Lemon AI\data
//
