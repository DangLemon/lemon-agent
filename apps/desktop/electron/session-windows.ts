...
// by main.ts (`setBackgroundThrottling` driven by the merged `lemon:active-work`
...
// (the "Lemon AI idles at 20% CPU while minimized" bug). The preload path is
...
// conversation started by the "Hey Lemon AI" wake word has NO preceding click,
