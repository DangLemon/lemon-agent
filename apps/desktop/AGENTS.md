...
How to build Lemon AI well. This is a judgment guide, not an inventory —
...
- The **backend** is authoritative for anything another Lemon AI surface can also
...
- A **runtime home change** (switching the underlying `LEMON_HOME` profile) is
...
its shape. "Plugin" means several unrelated things across Lemon AI — do not assume
