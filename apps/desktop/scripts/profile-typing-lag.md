...
cd apps/desktop
XCURSOR_SIZE=24 LEMON_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/lemon-typing
# → /tmp/lemon-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/lemon-typing.before.heapsnapshot
# → /tmp/lemon-typing.after.heapsnapshot
```
