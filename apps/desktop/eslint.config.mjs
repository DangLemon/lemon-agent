...
export default [
  ...
  {
    // THE PLUGIN FENCE: plugins speak @lemon-ai/plugin-sdk (+ react), never `@/…`
    ...
    rules: {
      'no-restricted-imports': [
        'error',
        {
          patterns: [
            {
              group: ['@/*', '../*', '@lemon-ai/shared'],
              message: 'Plugins import only @lemon-ai/plugin-sdk (and react). Missing something? Add it to the SDK.'
            }
          ]
        }
      ]
